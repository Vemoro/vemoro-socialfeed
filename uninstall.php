...
foreach (array('lif_settings','lif_status','lif_token','lif_db_version','lif_cache_version','lif_refresh_generation','lif_applied_refresh_generation','lif_secret_app_secret','lif_secret_access_token') as $option) { delete_option($option); }
