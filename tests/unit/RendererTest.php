...
final class RendererTest extends WP_UnitTestCase {
	...
	public function test_empty_feed_is_escaped_local_markup(): void { $renderer=new FeedRenderer(new PostRepository());$html=$renderer->render();$this->assertStringContainsString('lif-feed-empty',$html);$this->assertStringNotContainsString('instagram.com/embed',$html); }
}
